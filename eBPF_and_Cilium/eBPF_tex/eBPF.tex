...
\begin{itemize}
    ...
    \item Outperforms \textsl{IPtables} based solutions
\end{itemize}
...
\begin{description}
    ...
    \end{itemize}
    \item [Metrics:] Aggregated, structured data used to monitor a program or system performance at a specific point in time.
    \begin{itemize}
...
\begin{description}
    \item [eBPF Verifier:] Ensures eBPF programs are safe to run in the kernel.
        \begin{itemize}
    ...
    \item [JIT Compiler:] Translates eBPF bytecode into native machine code for improved performance.
        \begin{itemize}
            \item only invoked after the eBPF Verifier has verified the program is safe to run.
        \end{itemize}
...
\subsection{Hash Maps}
    \begin{itemize}
        \item key-value stores optimized for fast lookups.
    \end{itemize}

\subsection{Array Maps}
    \begin{itemize}
        \item fixed-size arrays indexed by integers.
    \end{itemize}

\subsection{Per-CPU Maps}
    \begin{itemize}
        \item stores separate values for each CPU core.
    \end{itemize}

\subsection{LRU Maps}
    \begin{itemize}
        \item \textsl{Least Recently Used} maps for caching data with eviction policies.
    \end{itemize}
\end{document}
