...
\begin{figure}
  ...
  keepaspectratio]{/Users/tj/Documents/StudyGuides/latex/tex_101/Chapter 05/png-clipart-drawing-car-rat-fink-decal-art-car-face-monochrome.png}
\end{figure}
...
\begin{itemize}
    ...
    \item \texttt{kubectl explain  <resource> --recursive} - Show documentation for a resource and all its fields recursively.
\end{itemize}
